...
class ReferenceDataManager {
	...
	constructor(context: vscode.ExtensionContext) {
		...
		// 加载数据
		this.loadReferences();
		console.log('(00)============================================>context.storageUri:',context.storageUri?.fsPath)
		console.log('(00)============================================>context.globalStorageUri:',context.globalStorageUri.fsPath)
	}

	// 加载引用数据
	private loadReferences(): void {
		console.log('(00)====>loadReferences:','OK')
		try {
...
class FileRefTagsViewProvider implements vscode.WebviewViewProvider {
	...
	resolveWebviewView(
		...
		webviewView.webview.onDidReceiveMessage(
			message => {
				console.log('(00)====>webviewView.webview.onDidReceiveMessage')
				console.log('(00)====>webviewView.webview.onDidReceiveMessage-message.command:',message.command)
	...
	private async _showStorageLocation(): Promise<void> {
		console.log('(00)=====>_showStorageLocation:','OK')
		try {
	...
	async getAllItem() : Promise<void>{
		...
		console.log('(00)=====>getAllItem():uri:',uri)
		...
		console.log('(00)=====>getAllItem():result:',result)
	}
}

// This method is called when your extension is activated
// Your extension is activated the very first time the command is executed
export function activateFRT(context: vscode.ExtensionContext) {
	...
	console.log('(00)======>context:',context)
	...
	// };
	// 注册处理URI的逻辑
	const handleUriFRT = async (uri: vscode.Uri) => {
		try {
			// 解析URL查询参数
			const query = new URLSearchParams(uri.query);
			const filePath = query.get('filePath');
	...
	registerUriRoute('/LiRenTech.file-ref-tags', handleUriFRT);
